...
def run_mp(interface, country, security, debug, peermac, ip, batman):
    ...
    if security == 'OPEN':
        if peermac != 0:
            os.system("sed -i " + '"s/#no_auto_peer=1/no_auto_peer=1/g"  ' + os.path.expanduser("~") + '/nrc_pkg/script/conf/' + country + '/mp_halow_open.conf ')
        else:
            os.system("sed -i " + '"s/ no_auto_peer=1/ #no_auto_peer=1/g"  ' + os.path.expanduser("~") + '/nrc_pkg/script/conf/' + country + '/mp_halow_open.conf ')
        os.system("sudo wpa_supplicant -i" + interface + " -c " + os.path.expanduser("~") + "/nrc_pkg/script/conf/" + country + "/mp_halow_open.conf " + debug + " &")
    elif security == 'WPA3-SAE':
        if peermac != 0:
            os.system("sed -i " + '"s/#no_auto_peer=1/no_auto_peer=1/g"  ' + os.path.expanduser("~") + '/nrc_pkg/script/conf/' + country + '/mp_halow_sae.conf ')
        else:
            os.system("sed -i " + '"s/ no_auto_peer=1/ #no_auto_peer=1/g"  ' + os.path.expanduser("~") + '/nrc_pkg/script/conf/' + country + '/mp_halow_sae.conf ')
        os.system("sudo wpa_supplicant -i" + interface + " -c " + os.path.expanduser("~") + "/nrc_pkg/script/conf/" + country + "/mp_halow_sae.conf " + debug + " &")
    time.sleep(1)
...
def run_map(wlan, mesh, country, security, debug, peermac, ip, batman):
    ...
    if security == 'OPEN':
        if peermac != 0:
            ...
            os.system("sed -i " + '"s/ no_auto_peer=1/ #no_auto_peer=1/g"  ' + os.path.expanduser("~") + '/nrc_pkg/script/conf/' + country + '/mp_halow_open.conf ')
        os.system("sudo wpa_supplicant -i" + mesh + " -c " + os.path.expanduser("~") + "/nrc_pkg/script/conf/" + country + "/mp_halow_open.conf " + debug + " &")
    else:
        if peermac != 0:
            os.system("sed -i " + '"s/#no_auto_peer=1/no_auto_peer=1/g"  ' + os.path.expanduser("~") + '/nrc_pkg/script/conf/' + country + '/mp_halow_sae.conf ')
        else:
            os.system("sed -i " + '"s/ no_auto_peer=1/ #no_auto_peer=1/g"  ' + os.path.expanduser("~") + '/nrc_pkg/script/conf/' + country + '/mp_halow_sae.conf ')
        os.system("sudo wpa_supplicant -i" + mesh + " -c " + os.path.expanduser("~") + "/nrc_pkg/script/conf/" + country + "/mp_halow_sae.conf " + debug + " &")
    time.sleep(1)
    ...
    if security == 'OPEN':
        os.system("sed -i " + '"4s/.*/interface=' + wlan + '/g"  ' + os.path.expanduser("~") + '/nrc_pkg/script/conf/' + country + '/map_halow_open.conf ')
        os.system("sudo hostapd " + os.path.expanduser("~") + "/nrc_pkg/script/conf/" + country + "/map_halow_open.conf " + debug +" &")
    elif security == 'WPA2-PSK':
        os.system("sed -i " + '"4s/.*/interface=' + wlan + '/g"  ' + os.path.expanduser("~") + '/nrc_pkg/script/conf/' + country + '/map_halow_wpa2.conf ')
        os.system("sudo hostapd " + os.path.expanduser("~") + "/nrc_pkg/script/conf/" + country + "/map_halow_wpa2.conf " + debug + "  &")
    elif security == 'WPA3-OWE':
        os.system("sed -i " + '"4s/.*/interface=' + wlan + '/g"  ' + os.path.expanduser("~") + '/nrc_pkg/script/conf/' + country + '/map_halow_owe.conf ')
        os.system("sudo hostapd " + os.path.expanduser("~") + "/nrc_pkg/script/conf/" + country + "/map_halow_owe.conf " + debug + "  &")
    elif security == 'WPA3-SAE':
        os.system("sed -i " + '"4s/.*/interface=' + wlan + '/g"  ' + os.path.expanduser("~") + '/nrc_pkg/script/conf/' + country + '/map_halow_sae.conf ')
        os.system("sudo hostapd " + os.path.expanduser("~") + "/nrc_pkg/script/conf/" + country + "/map_halow_sae.conf " + debug + "  &")
    elif security == 'WPA-PBC':
        os.system("sed -i " + '"4s/.*/interface=' + wlan + '/g"  ' + os.path.expanduser("~") + '/nrc_pkg/script/conf/' + country + '/map_halow_pbc.conf ')
        os.system("sudo hostapd " + os.path.expanduser("~") + "/nrc_pkg/script/conf/" + country + "/map_halow_pbc.conf " + debug + "  &")
        time.sleep(1)
